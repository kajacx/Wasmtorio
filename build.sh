...
cargo run --manifest-path /e/Programming/Rust/Wasynth/codegen/lua/Cargo.toml target/wasm32-unknown-unknown/release/wasmtorio_rust_plugin.wasm > rust-control.lua
# cargo run --manifest-path /e/Programming/Rust/Wasynth/Cargo.toml luajit target/wasm32-unknown-unknown/release/wasmtorio_rust_plugin.wasm > rust-control.lua


cp /e/Programming/Rust/Wasynth/codegen/lua/runtime/bit.lua ./bit.lua
